...
//From: https://github.com/pnikosis/materialish-progress/
//had to modify the progress wheel to make negative progress too! Grow and shrink circles, ya hear?
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isSpinning) {
            ...
            if (mProgress != mTargetProgress) {
                ...
                //we want to shrink you see!
                if(mTargetProgress < mProgress)
                    mProgress = Math.max(mTargetProgress, mProgress - deltaNormalized);
                else
