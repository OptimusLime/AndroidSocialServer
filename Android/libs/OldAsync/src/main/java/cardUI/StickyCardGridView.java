...
public class StickyCardGridView extends StickyGridHeadersGridView implements CardView.OnExpandListAnimatorListener {
        ...
        protected void initAttrs(AttributeSet attrs, int defStyle) {
            ...
            TypedArray a = getContext().getTheme().obtainStyledAttributes(
                    attrs, it.gmariotti.cardslib.library.R.styleable.card_options, defStyle, defStyle);

            try {
                list_card_layout_resourceID = a.getResourceId(it.gmariotti.cardslib.library.R.styleable.card_options_list_card_layout_resourceID, this.list_card_layout_resourceID);
            } finally {
                a.recycle();
            }
        }
